...
inline int choiceTrajectory(bool flag){
    
    int choice = 0;

    while(!flag)
    {
        std::cout << "Choose the Trajectory Type: " << std::endl;
        std::cout << "  1 - Rectilinear Trajectory with Trapezoidal Velocity " << std::endl;
        std::cout << "  2 - Circular Trajectory with Trapezoidal Velocity " << std::endl;
        std::cout << "  3 - Rectilinear Trajectory with Cubic Polynomial Velocity " << std::endl;
        std::cout << "  4 - Circular Trajectory with Cubic Polynomial Velocity " << std::endl;
        std::cin >> choice;
            switch (choice) {
                case 1:
                    flag = true;
                ...
                default:
                    // If the trajectory is not valid
                    std::cerr << "Trajectory Type not valid! Retry again." << std::endl;
                    break;
                }
    }
    return choice;
...
inline int choiceController(bool flag){
    
    int choice = 0;

    while(!flag)
    {
        std::cout << "Choose the Controller: " << std::endl;
        std::cout << "  1 - PD with Gravity Compensation in Joint Space " << std::endl;
        std::cout << "  2 - Inverse Dynamic Control in Operational Space " << std::endl;
        std::cin >> choice;
            switch (choice) {
                case 1:
                    flag = true;
                ...
                default:
                    // If the controller is not valid
                    std::cerr << "Controller not valid! Retry again." << std::endl;
                    break;
                }
    }
    return choice;
