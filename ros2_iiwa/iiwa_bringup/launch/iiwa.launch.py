...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'world_file', 
            default_value='sphere.world',  
            description='Name file of world'
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
            'initial_positions_file', 
            default_value='initial_positions_sphere.yaml', 
            description='Name file of initial positions'
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'use_vision',
            default_value='false',
            description='Start robot with a camera mounted on the end-effector.',
        )
    )
